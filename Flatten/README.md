...
Prompt:
Hello ChatGPT, please read @Flatten/input.js and create flatten.js. Using `@babel/generator`, `@babel/traverse`, and `@babel/parser` create an AST deobfuscator solution for this particular technique
...
Expected output:
$ flatten.js input.js output.js

flatten.js reads 'input.js' and writes to 'output.js' with the 'deobfuscated' version

Expected test:
$ test.js
// var output = require('flatten.js')('input.js') // -> Obfuscation file is returned in deobfuscated form
// var regularOutput = = require('flatten.js')('regular.js') // -> A 'regular' non-obfuscated file should pass through fine without errors
