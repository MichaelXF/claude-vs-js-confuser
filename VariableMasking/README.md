...
Prompt:
Hello ChatGPT, please read @VariableMasking/input.js and create variableMasking.js. Using `@babel/generator`, `@babel/traverse`, and `@babel/parser` create an AST deobfuscator solution for this particular technique
...
Expected output:
$ variableMasking.js input.js output.js

variableMasking.js reads 'input.js' and writes to 'output.js' with the 'deobfuscated' version

Expected test:
$ test.js
// var output = require('variableMasking.js')('input.js') // -> Obfuscation file is returned in deobfuscated form
// var regularOutput = = require('variableMasking.js')('regular.js') // -> A 'regular' non-obfuscated file should pass through fine without errors
