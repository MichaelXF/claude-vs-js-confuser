(function () {
  ...
  var k = document;
  var m = window;
  var ba = k["documentElement"];
  var n = k["createElement"]["bind"](k);
  var ca = n("div");
  var p = n("table");
  var da = n("tbody");
  var ea = n("tr");
  ...
  var u = r["some"];
  var la = r["splice"];
  var ma = new RegExp("^#(?:[\\w-]|\\\\.|[^\\x00-\\xa0])*$", "");
  var na = new RegExp("^\\.(?:[\\w-]|\\\\.|[^\\x00-\\xa0])*$", "");
  var oa = new RegExp("<.+>", "");
  var pa = new RegExp("^\\w+$", "");
  function v(a, b) {
  ...
  var B = function () {
    function a(a, c) {
      if (a) {
        ...
        var b = a;
        if (C(a)) {
          if (b = (c instanceof B ? c[0] : c) || k, b = ma["test"](a) ? b["getElementById"](a["slice"](1)) : oa["test"](a) ? qa(a) : v(a, b), !b) {
            return;
          }
        } else {
          if (D(a)) {
  ...
  E["prop"] = function (a, b) {
    if (a) {
      if (C(a)) {
        return a = e[a] || a, 2 > arguments["length"] ? this[0] && this[0][a] : this["each"](function (c, h) {
          h[a] = b;
        });
      }
      for (var c in a) {
  ...
  function K() {
    ...
    for (var h = 0; h < d; h++) {
      ...
      var g;
      for (g in f) {
        b && (q(f[g]) || I(f[g])) ? (c[g] && c[g]["constructor"] === f[g]["constructor"] || (c[g] = new f[g]["constructor"]()), K(b, c[g], f[g])) : c[g] = f[g];
      }
    }
    return c;
  }
  ...
  E["data"] = function (a, b) {
    ...
    if (C(a)) {
      return 2 > arguments["length"] ? this[0] && Ba(this[0], a) : void 0 === b ? this : this["each"](function (c, d) {
        c = b;
  ...
  J([!0, !1], function (a, b) {
    J(["Width", "Height"], function (a, d) {
      E[(b ? "outer" : "inner") + d] = function (c) {
        if (this[0]) {
          return H(this[0]) ? b ? this[0]["inner" + d] : this[0]["document"]["documentElement"]["client" + d] : w(this[0]) ? Ca(this[0], d) : this[0][(b ? "offset" : "client") + d] + (c && b ? R(this[0], "margin" + (a ? "Top" : "Left")) + R(this[0], "margin" + (a ? "Bottom" : "Right")) : 0);
        }
      };
    });
  });
  J(["Width", "Height"], function (a, b) {
    ...
    E[c] = function (d) {
      if (!this[0]) {
        return void 0 === d ? void 0 : this;
      }
      if (!arguments["length"]) {
        return H(this[0]) ? this[0]["document"]["documentElement"]["client" + b] : w(this[0]) ? Ca(this[0], b) : this[0]["getBoundingClientRect"]()[c] - Da(this[0], !a);
      }
      var h = parseInt(d, 10);
    ...
    return this["each"](function (b, c) {
      if (x(c)) {
        if (void 0 === a ? "none" === Q(c, "display") : a) {
          ...
          c["___cd"] = Q(c, "display"), c["style"]["display"] = "none";
        }
      }
    });
  };
  ...
  var Fa = new RegExp("^(mouse|pointer|contextmenu|drag|drop|click|dblclick)", "i");
        ...
        if (x(f) || w(f) || H(f)) {
          a = function La(a) {
            ...
            if (!a["namespace"] || Ea(l, a["namespace"]["split"]("."))) {
              if (b || !(Ka && (a["target"] !== f || a["___ot"] === z) || y && a["relatedTarget"] && f["contains"](a["relatedTarget"]))) {
                var g = f;
                if (b) {
  ...
  var Ia = new RegExp("%20", "g");
  var Ja = new RegExp("\\r?\\n", "g");
  var Ma = new RegExp("file|reset|submit|button|image", "i");
  var Na = new RegExp("radio|checkbox", "i");
  ...
  var Oa = new RegExp("^\\s*<(\\w+)[^>]*>", "");
  var Pa = new RegExp("^<(\\w+)\\s*\\/?>(?:<\\/\\1>)?$", "");
  var Qa = {
    "*": ca,
    ["tr"]: da,
    ["td"]: ea,
  ...
  E["position"] = function () {
    ...
    if (a) {
      ...
      var c = b ? a["getBoundingClientRect"]() : this["offset"]();
      if (!b) {
  ...
  var Ra = new RegExp("^\\s*<!(?:\\[CDATA\\[|--)|(?:\\]\\]|--)>\\s*$", "g");
  var Sa = new RegExp("^$|^module$|\\/(java|ecma)script", "i");
  var Ta = ["type", "src", "nonce", "noModule"];
  function Ua(a, b) {
    a = F(a);
